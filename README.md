...
| M11 | HTMX web UI for EN (multi-language template kit) | ✅ shipped (`humanize-en ui` serves the full EN single-page UI) |
...
# Launch the HTMX web UI + JSON API (M11 shipped).
# Open http://127.0.0.1:8765/ in a browser — single-page UI with
# detect / polish / judge tabs. /api/... endpoints are also available.
